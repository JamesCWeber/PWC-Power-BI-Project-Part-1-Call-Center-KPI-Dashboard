...
* With 4054 calls answered and 8 agents, the average number of calls an agent answers in 3 months is approximately 507 calls. Assuming that each agent can comfortably answer 507 calls per 3 months, adding 2 more agents will increase the total number of answered calls to 5070 calls, which is just over the 5000 total calls in this data set.
